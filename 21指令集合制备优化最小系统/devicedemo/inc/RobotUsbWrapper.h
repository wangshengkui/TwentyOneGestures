...
public:
	...
	//设置X10自定义点阵信息
	virtual void SetCustomMatrix(int xStart, int yStart, int xEnd, int yEnd, int itemWidth, int itemHeight) = 0;
#ifdef USE_RECOG
	//////////////////////////////////////////////笔记识别接口//////////////////////////////////////////////
	//设置识别回调函数
...
//设置X10自定义点阵信息
extern "C" ROBOT_API void SetCustomMatrix(int xStart, int yStart, int xEnd, int yEnd, int itemWidth, int itemHeight);
#ifdef USE_RECOG
//////////////////////////////////////////////笔记识别接口//////////////////////////////////////////////
//设置识别回调函数
